      ...
      <div className="collapse navbar-collapse" id="navbarsExampleXxl">
        ...
        <li className="nav-item dropdown ms-5">
            ...
            <ul className="dropdown-menu">
              ...
              <li><Link className="dropdown-item" to="/meetingScheduler">Meetting Schedule</Link></li>
            </ul>
          </li>
          <li>
        <form role="search" className="pe-5 me-2">
          ...
          <li className="nav-item dropdown" >
            <Link className="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">More</Link>
            <ul className="dropdown-menu">
