    ...
    if (isLoggedIn) {
      const decodeToken = async () => {
        ...
        if (!token) {
          ...
          console.log('from Navbar:', userType);
          ...
          <div className="collapse navbar-collapse" id="navbarsExampleXxl">
            ...
            {isLoggedIn? (
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu"> <li>   <Link to="/aboutUs" className="dropdown-item">     AboutUs   </Link> </li> <li>   <Link className="dropdown-item" to="/faq">     FAQs   </Link> </li> <li>   <Link className="dropdown-item" to="/feedBack">     Feed-Back   </Link> </li>
                </ul>
              </li>
              {isLoggedIn ? (
                <li className="nav-item" id="navMore">  <button className="nav-link" id="logout" onClick={handleLogout}>LogOut</button>
                </li>
              ) : (
