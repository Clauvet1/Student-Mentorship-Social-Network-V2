...
const Mentors = () => {
    return ( 
        ...
        <div className="container">
                <div id='mentorDesc' className="row">
                    <div className="col-lg-3">
                        <div id="shadow">
                        <div className="mentorIMG">
                            <img className='w-100' src={mentorIMG} alt="" />    
                        </div>    
                        </div>
                    </div> 
                    ...
                    <div className="container">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus eius eveniet recusandae consectetur! Omnis beatae porro amet hic ea officia quibusdam quia atque, sunt libero fugiat officiis nostrum eius incidunt.</p>
